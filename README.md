...
This project is to identify students for student intervention system which have higher probability to drop out. The code and results are available in `student_intervention.ipynb`
